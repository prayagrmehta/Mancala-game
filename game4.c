...
int main(int argc, char *argv[]) {
    ...
    gtk_css_provider_load_from_data(cssProvider,
        "#player1-bin { background-color: #ffcccb; border-radius: 15px; color: black; }"
        "#player2-bin { background-color: #add8e6; border-radius: 15px; color: black; }"
        "button { font-size: 20px; font-weight: bold; padding: 20px; }"
        "label { font-size: 20px; }"
        "button:hover { background-color: #f0a3a3; }", // Hover effect for player 1
        -1, NULL);
